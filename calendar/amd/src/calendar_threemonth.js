...
function(
    ...
    var registerCalendarEventListeners = function(root) {
        var body = $('body');
        body.on(CalendarEvents.monthChanged, function(e, newTimestamp, courseId) {
            ...
            root.queue(function(next) {
                return processRequest(e, newTimestamp, courseId)
                .then(function() {
                    return next();
                });
            });
        ...
        var processRequest = function(e, newTimestamp, courseId) {
            var newCurrentMonth = root.find('[data-current-time="' + newTimestamp + '"]');
