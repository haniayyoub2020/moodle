...
class cache implements cache_loader {
     ...
     * This is in the for timestampWithFloat-randomString.
     * @var string
     */
    ...
    protected function handle_invalidation_events() {
        ...
        // c) If the purge token is older than the last invalidation, or it has a different token component, then the cache is purged.
        //
