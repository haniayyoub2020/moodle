...
Feature: Star and unstar conversations
  ...
  Scenario: Star a group conversation
    ...
    And I should see "Group 1" in the "favourites" "core_message > Group message > List area"
    And I open the "Group" conversations list
    And I should not see "Group 1" in the "group-messages" "core_message > Group message > List area"
  ...
  Scenario: Unstar a group conversation
    ...
    And I go back in "view-conversation" message drawer
    And I open the "Starred" conversations list
    And I should not see "Group 1" in the "favourites" "core_message > Group message > List area"
    And I open the "Group" conversations list
    And I should see "Group 1" in the "group-messages" "core_message > Group message > List area"
  ...
  Scenario: Star a private conversation
    ...
    And I open the "Private" conversations list
    And I should not see "Student 2" in the "messages" "core_message > Group message > List area"
  ...
  Scenario: Unstar a private conversation
    ...
    And I should not see "Group 1" in the "favourites" "core_message > Group message > List area"
    And I open the "Private" conversations list
    And I should see "Student 2" in the "messages" "core_message > Group message > List area"
