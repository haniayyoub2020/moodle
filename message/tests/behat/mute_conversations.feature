...
Feature: Mute and unmute conversations
  ...
  Scenario: Mute a group conversation
    ...
    And "muted" "icon_container" in the "Group 1" "core_message > Group message" should not be visible
    And I select "Group 1" conversation in messaging
    And "muted" "icon_container" in the "Group 1" "core_message > Group message > Header" should not be visible
    And I open contact menu
    And I click on "Mute" "link" in the "[data-region='header-container']" "css_element"
    And "muted" "icon_container" in the "Group 1" "core_message > Group message > Header" should be visible
    And I go back in "view-conversation" message drawer
    And "muted" "icon_container" in the "Group 1" "core_message > Group message" should be visible
  ...
  Scenario: Mute a private conversation
    ...
    And "muted" "icon_container" in the "Student 2" "core_message > Group message" should not be visible
    ...
    And I go back in "view-conversation" message drawer
    And "muted" "icon_container" in the "Student 2" "core_message > Group message" should be visible
