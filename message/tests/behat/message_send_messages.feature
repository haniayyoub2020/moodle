...
Feature: Message send messages
  ...
  Scenario: Send a message to a group conversation
    ...
    Then I should see "Hi!" in the "Group 1" "core_message > Group message > Conversation"
    ...
    And "Group 1" "core_message > Group message" should exist
    And I select "Group 1" conversation in messaging
    And I should see "Hi!" in the "Group 1" "core_message > Group message > Conversation"

  Scenario: Send a message to a starred conversation
    Given I log in as "student1"
    When I open messaging
    And I open the "Group" conversations list
    Then "Group 1" "core_message > Group message" should exist
    ...
    And I go back in "view-conversation" message drawer
    And I open the "Group" conversations list
    And I should not see "Group 1" in the "Group" "core_message > Group message > Tab"
