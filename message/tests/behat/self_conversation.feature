...
Feature: Self conversation
  ...
  Scenario: Self conversation exists
    ...
    Then "Student 1" "core_message > Group message" should exist
  ...
  Scenario: Self conversation can be unstarred
    ...
    And I click on "Unstar" "link" in the "Student 1" "core_message > Group message > Header"
    And I go back in "view-conversation" message drawer
    And I open the "Starred" conversations list
    And I should not see "Student 1" in the "favourites" "core_message > Group message > List area"
    And I open the "Private" conversations list
    And I should see "Student 1" in the "messages" "core_message > Group message > List area"
  ...
  Scenario: Self conversation can be deleted
    ...
    And I open contact menu
    And I click on "Delete conversation" "link" in the "Student 1" "core_message > Group message > Header"
    ...
    And I should not see "Student 1" in the "favourites" "core_message > Group message > List area"
    And I open the "Private" conversations list
    And I should not see "Student 1" in the "messages" "core_message > Group message > List area"
