...
Feature: Create conversations for course's groups
  ...
  Scenario: Group conversations are restricted to members
    ...
    And "Group 2" "core_message > Group message" should exist
    And "Group 3" "core_message > Group message" should not exist
    And I log out
    And I log in as "student1"
    And I open messaging
    And I open the "Group" conversations list
    And "Group 1" "core_message > Group message" should exist
    And "Group 2" "core_message > Group message" should not exist
    And "Group 3" "core_message > Group message" should not exist
  ...
  Scenario: View group conversation's participants list
    ...
    And "Teacher 1" "core_message > Group message > Member" should not exist
    And "Student 0" "core_message > Group message > Member" should exist
    And "Student 1" "core_message > Group message > Member" should exist
    And "Student 2" "core_message > Group message > Member" should exist
    And "Student 3" "core_message > Group message > Member" should exist
    And "Student 4" "core_message > Group message > Member" should not exist
    ...
    And I open messaging information
    And "Teacher 1" "core_message > Group message > Member" should not exist
    And "No participants" "core_message > Group message > Member" should exist
    And "Student 4" "core_message > Group message > Member" should not exist
  ...
  Scenario: Check group conversation members are synced when a new group member is added
    ...
    And I open the "Group" conversations list
    And I select "Group 1" conversation in messaging
    And I should see "6 participants" in the "Group 1" "core_message > Group message > Header"
    And I open messaging information
    And "Student 4" "core_message > Group message > Member" should exist
    And I go back in "group-info-content-container" message drawer
    And I go back in "view-conversation" message drawer
    And I select "Group 2" conversation in messaging
    And I should see "2 participants" in the "Group 2" "core_message > Group message > Header"
    And I open messaging information
    And "No participants" "core_message > Group message > Member" should not exist
    And "Student 4" "core_message > Group message > Member" should exist
