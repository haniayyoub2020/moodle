...
Feature: Delete messages from conversations
  ...
  Scenario: Delete a message sent by the user from a group conversation
    ...
    And "Group 1" "core_message > Group message" should exist
    And I select "Group 1" conversation in messaging
    And I click on "Hi!" "core_message > Group message > Message > Content"
    And I click on "How are you?" "core_message > Group message > Message > Content"
    And I click on "Can somebody help me?" "core_message > Group message > Message > Content"
...
#   Deleting, so messages should not be there
    ...
    And I should see "##today##j F##" in the "Group 1" "core_message > Group message > Conversation"
    And I should see "How are you?" in the "Group 1" "core_message > Group message > Conversation"
    And I should see "Can somebody help me?" in the "Group 1" "core_message > Group message > Conversation"
...
#   Deleting, so messages should not be there
    ...
    And I should not see "Hi!"
    And I should see "##today##j F##" in the "Group 1" "core_message > Group message > Conversation"
    And I should not see "How are you?" in the "Group 1" "core_message > Group message > Conversation"
    And I should see "Can somebody help me?" in the "Group 1" "core_message > Group message > Conversation"
    And I should not see "Messages selected"
...
#   Deleting, so messages should not be there
    ...
    And I should see "Hello!" in the "Student 2" "core_message > Group message > Conversation"
    And I should see "Are you free?" in the "Student 2" "core_message > Group message > Conversation"
    And I should not see "Messages selected"
  ...
  Scenario: Delete two messages from a private conversation; one sent by another user
    ...
    And I click on "Hi!" "core_message > Group message > Message > Content"
    And I should see "1" in the "[data-region='message-selected-court']" "css_element"
    And I click on "Hello!" "core_message > Group message > Message > Content"
    And I should see "2" in the "[data-region='message-selected-court']" "css_element"
    And "Delete selected messages" "button" should exist
    When I click on "Delete selected messages" "button"
#   Deleting, so messages should not be there
    ...
    Then I should not see "Delete"
    And I should not see "Hi!"
    And I should not see "Hello!" in the "Student 2" "core_message > Group message > Conversation"
    And I should see "##today##j F##" in the "Student 2" "core_message > Group message > Conversation"
    And I should see "Are you free?" in the "Student 2" "core_message > Group message > Conversation"
    And I should not see "Messages selected"
...
#   Canceling deletion, so messages should be there
  ...
  Scenario: Check an empty favourite conversation is still favourite
    ...
    And I click on "Hi!" "core_message > Group message > Message > Content"
    And I click on "Hello!" "core_message > Group message > Message > Content"
    And I click on "Are you free?" "core_message > Group message > Message > Content"
    And "Delete selected messages" "button" should exist
    When I click on "Delete selected messages" "button"
    And I should see "Delete"
    And I click on "//button[@data-action='confirm-delete-selected-messages']" "xpath_element"
