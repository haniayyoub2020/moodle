...
$string['privacy:meetadata:forum_discussions'] = 'Information about the individual forum discussions that a user has created.';
$string['privacy:meetadata:forum_discussions:name'] = 'The name of the discussion, as chosen by the author.';
$string['privacy:meetadata:forum_discussions:userid'] = 'The ID of the user who created the discussion.';
$string['privacy:meetadata:forum_discussions:assessed'] = 'TODOD - what does this field store';
$string['privacy:meetadata:forum_discussions:timemodified'] = 'The time that the discussion was last modified.';
$string['privacy:meetadata:forum_discussions:usermodified'] = 'The ID of the user who last modified the discussion in some way.';
$string['privacy:meetadata:forum_discussion_subs'] = 'Information about the subscriptions to individual forum discussions.';
$string['privacy:meetadata:forum_discussion_subs:userid'] = 'The ID of the user with this subscription preference.';
$string['privacy:meetadata:forum_discussion_subs:discussionid'] = 'The ID of the discussion that was subscribed to.';
$string['privacy:meetadata:forum_discussion_subs:preference'] = 'The start time of the subscription.';
