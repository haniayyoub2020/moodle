...
$string['errormovingattachments'] = 'Errors occurred while moving attachment directories - check your file permissions';
$string['invalidpintype'] = 'Invalid value when attempting to pin/unpin discussion.';
$string['permissiondenied:pin'] = 'You do not have permission to pin discussions.';
$string['pinchanged:pinned'] = 'The discussion was pinned.';
$string['pinchanged:unpinned'] = 'The discussion was unpinned.';
