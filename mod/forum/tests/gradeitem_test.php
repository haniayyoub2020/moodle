...
class gradeitem_test extends \advanced_testcase {
    ...
    public function test_get_and_store_grade_for_user_with_simple_direct_grade(): void {
        ...
        // Store a new value.
        $gradeitem->store_grade_from_formdata($student->id, $grader->id, (object) ['grade' => $data]);
    }
    ...
    public function test_get_and_store_grade_for_user_with_rubric(): void {
        ...
        $data = $this->get_submitted_form_data($controller, [
            'Species' => [
                'score' => 4,
        ...
        // Store a new value.
        $gradeitem->store_grade_from_formdata($student->id, $grader->id, (object) ['criteria' => $data]);
    }
    ...
    protected function get_level_and_criterion_for_values(gradingform_controller $controller, string $description, float $score): array {
    ...
    protected function get_submitted_form_data(gradingform_controller $controller, array $values): array {
        $result = [];
