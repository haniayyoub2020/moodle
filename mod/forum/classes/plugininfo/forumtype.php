...
/**
 * Information about the forum type forum subplugin.
 *
 * @package    mod_forum
...
class forumtype extends base {
    ...
    public static function get_enabled_plugins() {
        ...
        $plugins = core_plugin_manager::instance()->get_installed_plugins('forumtypes');
        if (!$plugins) {
            return [];
        }
    ...
    public function load_settings(\part_of_admin_tree $adminroot, $parentnodename, $hassiteconfig) {
        ...
        if ($adminroot->fulltree) {
            $shortsubtype = substr($this->type, strlen('forum'));
