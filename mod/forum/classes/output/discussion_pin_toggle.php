...
/**
 * Templatable for a forum discussion pin toggle.
 *
 * @package    mod_forum
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class discussion_pin_toggle implements \renderable, \templatable {

    /**
     * @var \mod_forum\instance The forum whose pin is to be toggled.
     */
    protected $forum;
    ...
    public function export_for_template(\renderer_base $renderer) : \stdclass {
        return (object) [
            'can_pin' => $this->forum->can_pin_discussions(),
            'is_pinned' => $this->forum->is_discussion_pinned($this->discussion),
