...
class discussion_subscription_toggle implements \renderable, \templatable {
    ...
    /**
     * @var \mod_forum\instance The forum whose subscription toggle is to be shown.
     */
    protected $forum;
     ...
     */
    public function __construct(\mod_forum\instance $forum, \stdClass $discussion, $includetext = true) {
        $this->forum = $forum;
