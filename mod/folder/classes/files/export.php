...
use context;
use core_files\local\exporter\contentitem;
use core_files\local\exporter\exporter as parent_exporter;
use core_files\local\exporter\zipwriter;
use stdClass;
use stored_file;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class exporter extends parent_exporter {
