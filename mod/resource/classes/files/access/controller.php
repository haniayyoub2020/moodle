...
class controller extends mod_controller {
    ...
    protected function get_stored_file_from_pluginfile_params(context $context, string $filearea, array $args): ?stored_file {
        ...
        $file = $this->get_stored_file_from_filepath($context, $component, $filearea, $itemid, $relativepath, $filename);
        ...
        if (!$file) {
            ...
            $file = $file || $this->get_stored_file_from_filepath($context, $component, $filearea, $itemid, $relativepath, 'index.htm');
            $file = $file || $this->get_stored_file_from_filepath($context, $component, $filearea, $itemid, $relativepath, 'index.html');
            $file = $file || $this->get_stored_file_from_filepath($context, $component, $filearea, $itemid, $relativepath, 'Default.htm');
