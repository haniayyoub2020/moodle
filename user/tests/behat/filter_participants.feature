...
Feature: Course participants can be filtered
  ...
  Scenario: Multiple filters applied (All filterset match type)
    ...
    When I click on "Remove \"Active\" from filter" "button" in the "Filter 2" "fieldset"
    ...
    When I click on "Remove \"Inactive\" from filter" "button" in the "Filter 2" "fieldset"
    And I set the field "Type or select..." in the "Filter 2" "fieldset" to "Active"
    And I set the field "Type or select..." in the "Filter 2" "fieldset" to "Inactive"
    And I click on "Apply filters" "button"
  ...
  Scenario: Filter match by one or more keywords and modified match types
    ...
    When I set the field "Type..." to "1@example"
  ...
  Scenario: Filter by user identity fields
    ...
    When I click on "Remove \"student1@example.com\" from filter" "button" in the "Filter 1" "fieldset"
    ...
    When I click on "Remove \"SID\" from filter" "button" in the "Filter 1" "fieldset"
    ...
    When I click on "Remove \"SCITY\" from filter" "button" in the "Filter 1" "fieldset"
    ...
    When I click on "Remove \"GB\" from filter" "button" in the "Filter 1" "fieldset"
  ...
  Scenario: Filter by user identity fields when cannot see the field data
    ...
    #   Keyword Any ["SID"].
    # Set the Keyword to "Any" ["SID"]
    When I click on "Remove \"@example.\" from filter" "button" in the "Filter 1" "fieldset"
    And I set the field "Type..." in the "Filter 1" "fieldset" to "SID"
    And I click on "Apply filters" "button"
    ...
    When I click on "Remove \"TID\" from filter" "button" in the "Filter 1" "fieldset"
    ...
    # Set the Keyword to "Any" ["NOTHING"]
    When I click on "Remove \"CITY\" from filter" "button" in the "Filter 1" "fieldset"
    And I set the field "Type..." in the "Filter 1" "fieldset" to "NOTHING"
    And I click on "Apply filters" "button"
