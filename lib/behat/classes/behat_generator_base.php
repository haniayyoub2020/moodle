...
abstract class behat_generator_base {
     ...
     * @param bool      $onlyone Whether there is only one record and it is pivotted
     */
    public function generate_items(string $generatortype, TableNode $data, bool $onlyone = false) {
