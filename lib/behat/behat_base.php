...
EOF;
     ...
     * @return mixed
     */
    public function evaluate_script(string $script, array $arguments = []) {
     ...
     * @return mixed
     */
    public static function evaluate_script_in_session(Session $session, string $script, array $arguments = []) {
