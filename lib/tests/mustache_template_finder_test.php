...
class core_output_mustache_template_finder_testcase extends advanced_testcase {
    ...
    public function test_get_template_directories_for_component() {
        ...
        // Test a plugin.
        $dirs = mustache_template_finder::get_template_directories_for_component('mod_assign', 'boost');
        ...
        // Test a subsystem.
        $dirs = mustache_template_finder::get_template_directories_for_component('core_user', 'boost');
        ...
        // Test core.
        $dirs = mustache_template_finder::get_template_directories_for_component('core', 'boost');
    ...
    public function test_invalid_get_template_directories_for_component() {
        ...
        $dirs = mustache_template_finder::get_template_directories_for_component('octopus', 'boost');
    }

    public function test_get_template_filepath() {
        global $CFG;

        $filename = mustache_template_finder::get_template_filepath('core/pix_icon', 'boost');
    ...
    public function test_invalid_get_template_filepath() {
        // Test something invalid.
        $dirs = mustache_template_finder::get_template_filepath('core/octopus', 'boost');
    }
}
