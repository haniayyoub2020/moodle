    ...
    var addAccessibleChangeListener = function(element) {
        ...
        if (onMac || touchEnabled) {
            ...
            nativeElement.addEventListener('focus', function(e) {
                ...
                window.console.log("Focusing");
            }, true);
            nativeElement.addEventListener('blur', function(e) {
                window.console.log("Blurring");
                var initValue = e.target.dataset.initValue;
                delete e.target.dataset.initValue;
                if (e.target.value !== initValue) {
                    triggerEvent(events.accessibleChange, e);
                }
            }, true);
            element.on('keydown', function(e) {
                window.console.log("keyDown " + e.keycode + ":" + e.code);
                if ((e.which === keyCodes.enter) && e.target.value !== $(e.target).data('initValue')) {
                window.console.log("Triggering");
                    triggerEvent(events.accessibleChange, e);
                } else if (e.which === keyCodes.escape) {
                window.console.log("Resetting to initValue");
                    e.target.value = e.target.dataset.initValue;
                } else {
            ...
            window.console.log("Caught the click");
            window.console.log(e);
                var initValue = e.target.dataset.initValue;
