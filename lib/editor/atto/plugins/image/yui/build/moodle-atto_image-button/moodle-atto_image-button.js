...
Y.namespace('M.atto_image').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    initializer: function() {
        ...
        // Prevent default needed to stop the default event from clobbering the desired behaviour in some browsers.
    ...
    _loadPreviewImage: function(url) {
        ...
        M.util.js_pending('atto_image:_loadPreviewImage');
        ...
        image.onerror = function() {
            ...
            M.util.js_complete('atto_image:_loadPreviewImage');
        };
    ...
    _setImage: function(e) {
        M.util.js_pending('atto_image:_setImage');
        var form = this._form,
        ...
        if (this._updateWarning()) {
            M.util.js_complete('atto_image:_setImage');
            return;
        }
