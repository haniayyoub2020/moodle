...
class core_files_file_system_filedir_testcase extends advanced_testcase {
    ...
    public function test_readonly_filesystem_filedir() {
        ...
        // Adjust the filedir to be a subdirectory of filedir.
        //$CFG->filedir = $CFG->filedir . DIRECTORY_SEPARATOR . 'subdir';
    ...
    public function test_try_content_recovery() {
        ...
        $fs = new file_system_filedir();
        $method = new ReflectionMethod(file_system_filedir::class, 'try_content_recovery');
        $method->setAccessible(true);
        $result = $method->invokeArgs($fs, array($file));
     ...
     * Ensure that content recovery works.
     */
    public function test_try_content_recovery_already_present() {
        $this->resetAfterTest();
        global $CFG;
     ...
     * Ensure that content recovery works.
     */
    public function test_try_content_recovery_size_mismatch() {
        $this->resetAfterTest();
        global $CFG;
     ...
     * Ensure that content recovery works.
     */
    public function test_try_content_recovery_has_mismatch() {
        $this->resetAfterTest();
        global $CFG;
     ...
     * alt trash directory.
     */
    public function test_try_content_recovery_alttrash() {
        $this->resetAfterTest();
        global $CFG;
     ...
     */
    public function test_try_content_recovery_contentdir_readonly() {
        $this->resetAfterTest();
        global $CFG;
    ...
    public function test_add_file_to_pool_mismatched_hash() {
        ...
        $fs->add_file_to_pool($filepath, 'eee4943847a35a4b6942c6f96daafde06bcfdfab');
    ...
    public function test_add_file_to_pool_existing_content_invalid() {
        ...
        $fs = new file_system_filedir();
        $filepath = \org\bovigo\vfs\vfsStream::url('root/sourcedir/file');
        $result = $fs->add_file_to_pool($filepath);
    ...
    /**
     * Test the cleanup of deleted files.
     */
    public function test_remove_file() {
        ...
        $fs = new file_system_filedir();
        $method = new ReflectionMethod(file_system_filedir::class, 'remove_file');
        $method->setAccessible(true);
        $method->invokeArgs($fs, array($contenthash));
     ...
     */
    public function test_remove_file_file_missing() {
        $this->resetAfterTest();
        global $CFG;
