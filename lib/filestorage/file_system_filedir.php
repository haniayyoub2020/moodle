...
class file_system_filedir extends file_system {
     ...
     * @return bool success
     */
    protected function try_content_recovery(stored_file $file) {
        $contentfile = $this->get_local_path_from_storedfile($file, true);
     ...
     */
    protected function remove_file($contenthash) {
