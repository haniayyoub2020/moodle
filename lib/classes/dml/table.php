...
class table {
    ...
    /**
     * Constrctor for the table calss.
     *
     ...
     *
     * This function is intended to be used in combination with `extract_table_from_result`.
     *
     ...
     */
    public function extract_record_from_result(stdClass $result) : stdClass {
        $record = new stdClass();
