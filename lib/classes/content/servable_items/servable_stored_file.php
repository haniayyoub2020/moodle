...
class servable_stored_file extends servable_item {
     ...
     */
    public function __construct(string $component, context $context, filearea $filearea, stored_file $file) {
    ...
    /**
     * Confirm whether the specified user can access this stored file from the specified context.
     *
     * @param   stdClass $user
    ...
    public function user_can_access_from_context(object $user, context $viewedcontext): bool {
        return $this->fileareahandler::can_access_stored_file($this->file, $viewedcontext);
    }
