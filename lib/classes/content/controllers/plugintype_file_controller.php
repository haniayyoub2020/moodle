...
/**
 * A class to help define, describe, and control access to file content within a plugintype of Moodle.
 *
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class plugintype_file_controller extends file_controller {
    ...
    protected static function get_filearea_classname_for_component(string $component, string $filearea): string {
        ...
        return "\\core\\content\\plugintypes\\{$plugintype}\\fileareas\\{$filearea}";
    }
    ...
    public static function get_contentarea_classname_for_component(string $component): string {
        ...
        return "\\core\\content\\plugintypes\\{$plugintype}\\file_controller";
    }
}
