...
class numeric_comparison_filter extends filter {
    ...
    public function add_filter_value($value): parent {
        if (!is_string($value)) {
            ...
            throw new InvalidArgumentException("The value supplied was of type '{$type}'. A string representing a json-encoded value was expected.");
        }

        $data = json_decode($value);

        if ($data === null) {
            throw new InvalidArgumentException("A json-encoded object containing both a direction, and comparison value was expected.");
        }
        ...
        if (!is_numeric($value)) {
            ...
            throw new InvalidArgumentException("The value supplied was of type '{$type}'. A numeric value was expected.");
        }
