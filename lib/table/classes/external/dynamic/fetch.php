...
class fetch extends external_api {
    ...
    public static function execute(string $handler, string $uniqueid, string $sortby, string $sortorder, array $filters = [], string $jointype = null) {
        ...
        $baseurl = new moodle_url('/user/index.php', array(
            ...
            'id' => 5,
            'perpage' => 20));
        $instance->define_baseurl($baseurl);
        ob_start();
        $instance->out(20, true);
        $participanttablehtml = ob_get_contents();
        ob_end_clean();

        return ['attr' => 'attr list here', 'html' => $participanttablehtml];
    }
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'attr' => new external_value(PARAM_RAW, 'List of attributes used in the search'),
