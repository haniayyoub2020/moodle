 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class framework implements \H5PFrameworkInterface, \core_h5p\framework {
    ...
    public function saveLibraryData(&$librarydata, $new = true) {
        ...
        if (array_key_exists('coreApi', $librarydata)) {
            $library['coreapi'] = "{$librarydata['coreApi']['majorVersion']}.{$librarydata['coreApi']['minorVersion']}";
        }
    ...
    public function updateContent($content, $contentmainid = null) {
        ...
        $data = array(
            ...
            'displayoptions' => $content['disable'] ?? null,
