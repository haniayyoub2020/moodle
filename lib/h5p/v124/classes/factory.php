 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class factory implements \core_h5p\factory {
    ...
    /**
     * Returns an instance of the \core_h5p\player class.
     *
     ...
     */
    public function get_core(): \core_h5p\core {
        if (null === $this->core) {
          $fs = new file_storage();
    ...
    public function get_core_classname(): string {
        return core::class;
    }

    public function get_autoloader_classname(): string {
     ...
     * @return \H5PStorage
     */
    public function get_storage(): \core_h5p\storage {
     ...
     * @return \H5PValidator
     */
    public function get_validator(): \core_h5p\validator {
     ...
     */
    public function get_content_validator(): \core_h5p\content_validator {
