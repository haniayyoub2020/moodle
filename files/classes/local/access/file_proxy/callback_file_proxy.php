 ...
 */
namespace core_files\local\access\file_proxy;

use core_files\local\access\file_proxy as file_proxy_base;

/**
 * Metadata used to serve raw content.
 *
 * @copyright   2020 Andrew Nicols <andrew@nicols.co.uk>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class callback_file_proxy extends file_proxy_base {
