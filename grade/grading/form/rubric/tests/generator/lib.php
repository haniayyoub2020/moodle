...
class gradingform_rubric_generator extends component_generator_base {
    ...
    /**
     * Given a controller instance, fetch the level and criterion informatio for the specified values.
     *
     ...
     * @return array
     */
    public function get_level_and_criterion_for_values(gradingform_controller $controller, string $description, float $score): array {
