    ...
    public static function get_fetch_data(gradeitem $gradeitem, stdClass $gradeduser): array {
        ...
        if ($definition->rubric_criteria) {
            $criterion = array_map(function($criterion) use ($fillings) {
                ...
                $result['levels'] = array_map(function($level) use ($criterion, $filling) {
                    $result = [
                        'id' => $level['id'],
                        'criterionid' => $criterion['id'],
                        'score' => $level['score'],
                        'definition' => $level['definition'],
                        'definitionformat' => $criterion['definitionformat'],
                        'checked' => null,
                        'currentchecked' => null,

                    ];

                    if ($filling['levelid'] == $level['id']) {
                        $result['checked'] = true;
                        $result['currentchecked'] = true;
                    }
        ...
        return [
            ...
            'grade' => [
                ...
                'teacherdescription' => $definition->description,
                'teacherdescriptionformat' => $definition->descriptionformat,
                'canedit' => false,
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            ...
            'grade' => new external_single_structure([
                ...
                'teacherdescriptionformat' => new external_format_value('teacherdescription'),
