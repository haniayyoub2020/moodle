...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $temp->add(new admin_setting_configtext('geoipremote', new lang_string('geoipremote', 'admin'),
        new lang_string('configgeoipremote', 'admin'), 'https://freegeoip.net/json', PARAM_URL));
