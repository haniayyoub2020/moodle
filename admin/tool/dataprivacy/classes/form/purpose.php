...
class purpose extends persistent {
    ...
    protected function add_override_fields() {
        ...
        $overrideelements = [
            ...
            $this->_form->createElement('static', 'roleoverrideoverview', '', get_string('roleoverrideoverview', 'tool_dataprivacy')),
        ];
    ...
    protected function get_sensitive_base_field(string $prefix = '') : \stdClass {
        ...
        $data->fields[] = $this->_form->createElement('autocomplete', $fieldname, get_string('sensitivedatareasons', 'tool_dataprivacy'),
            $bases,
            [
                'multiple' => true,
            ]
