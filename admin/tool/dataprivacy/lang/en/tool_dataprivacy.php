...
$string['confirmrequestresubmitall'] = 'Are you sure you wish to cancel {$a->requestcount} requests and resubmit them?';
...
$string['resubmitallrequests'] = 'Reject and resubmit {$a->requestcount} requests';
$string['resubmitallrequestsbutton'] = 'Resubmit all requests';
$string['resubmittedrequest'] = 'The existing {$a->type} request for {$a->username} was cancelled and resubmitted';
$string['resubmittedallrequests'] = '{$a->requestcount} requests were cancelled and resubmitted.';
