...
Feature: Manage data storage purposes
  ...
  Background:
    ...
    And I set the field "Lawful bases" to "Contract (GDPR Art. 6.1(b))"
    And I set the field "Lawful bases" to "Legal obligation (GDPR Art 6.1(c))"
    And I set the field "Sensitive personal data processing reasons" to "Explicit consent (GDPR Art. 9.2(a))"
  ...
  Scenario: Update a data storage purpose
    ...
    And I set the field "Lawful bases" to "Vital interests (GDPR Art. 6.1(d))"
