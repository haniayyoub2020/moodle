...
Feature: Verify that keyboard steps work as expected
  ...
  @javascript
  Scenario: Using home and end keys moves around a text field
    Given I click on "Log in" "link"
    And I click on "Username" "field"
    When I type "ron"
    ...
    And I type "r"
    Then the field "Username" matches value "saffronr"

  @javascript
  Scenario: Using left and right keys moves around a text field
    Given I click on "Log in" "link"
    And I click on "Username" "field"
    When I type "r"
