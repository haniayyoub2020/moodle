...
$minorversion): array {
     ...
     * @param  int    $minorversion    Minor version (any number will do)
     */
    public function create_library_files(string $uploaddirectory, int $libraryid, string $machinename,
            int $majorversion, int $minorversion) {

        // Create library directories.
        check_dir_exists($uploaddirectory);
        check_dir_exists($uploaddirectory . DIRECTORY_SEPARATOR . 'scripts');
        check_dir_exists($uploaddirectory . DIRECTORY_SEPARATOR . 'styles');
