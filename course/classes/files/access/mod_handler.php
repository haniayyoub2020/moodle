...
/**
 * File access handler for activity modules.
 *
 * @package     mod_folder
 * @copyright   2020 Andrew Nicols <andrew@nicols.co.uk>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace core_course\files\access;
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_handler extends handler_base {
     ...
     * @return  string
     */
    protected static function get_modname(): string {
        return substr(self::get_component(), 4);
    }
}
