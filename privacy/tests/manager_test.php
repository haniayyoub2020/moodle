...
class privacy_manager_testcase extends advanced_testcase {
    ...
    public function test_get_metadata_for_components() {
        ...
        $itemcollectionarray = $mockman->get_metadata_for_components();
        $this->assertArrayHasKey('mod_testcomponent', $itemcollectionarray);
        $itemcollection = $itemcollectionarray['mod_testcomponent'];
        $this->assertInstanceOf(\core_privacy\metadata\item_collection::class, $itemcollection);
        $this->assertArrayHasKey('mod_testcomponent3', $itemcollectionarray);
        $itemcollection = $itemcollectionarray['mod_testcomponent3'];
        $this->assertInstanceOf(\core_privacy\metadata\item_collection::class, $itemcollection);

        // Component which implements just the metadata\null_provider. Metadata is not provided.
        $this->assertArrayNotHasKey('mod_testcomponent2', $itemcollectionarray);
    }
    ...
    public function test_export_user_data() {
        ...
        $approvedcontextlistcollection = new \core_privacy\request\contextlist_collection();
